...
var CHAINRINGS_INFO = [
  {
    ...
    infos: [
      ...
      { brand: "Shimano",   model: "XTR M8000",           sprockets: [32] },
      { brand: "Shimano",   model: "XTR M8000",           sprockets: [34] },
      ...
      { brand: "Wolftooth", model: "96 BCD for Shimano",  sprockets: [32] },
      { brand: "Wolftooth", model: "96 BCD for Shimano",  sprockets: [34] },
      { brand: "Wolftooth", model: "110 BCD for Shimano", sprockets: [36] },
      { brand: "Wolftooth", model: "110 BCD for Shimano", sprockets: [38] },
      { brand: "Wolftooth", model: "110 BCD for Shimano", sprockets: [40] },
      { brand: "Wolftooth", model: "110 BCD for Shimano", sprockets: [42] },
      { brand: "Wolftooth", model: "110 BCD for Shimano", sprockets: [44] },
      { brand: "Wolftooth", model: "110 BCD for Shimano", sprockets: [46] },
      { brand: "Wolftooth", model: "110 BCD for Shimano", sprockets: [48] },
      { brand: "Wolftooth", model: "110 BCD for Shimano", sprockets: [50] },
  ...
  },
  {
    ...
    infos: [
      ...
      { brand: "FSA",            model: "SL-K Modular",         sprockets: [46, 30], note: "Adventure" },
      ...
      { brand: "Shimano (Road)", model: "Tiagra",               sprockets: [50, 34] },
      { brand: "Shimano (Road)", model: "105",                  sprockets: [50, 34] },
      { brand: "Shimano (Road)", model: "Ultegra",              sprockets: [46, 36] },
      { brand: "Shimano (Road)", model: "Ultegra",              sprockets: [50, 34] },
      { brand: "Shimano (Road)", model: "Ultegra",              sprockets: [52, 36] },
      { brand: "Shimano (Road)", model: "Ultegra",              sprockets: [53, 39] },
      { brand: "Shimano (Road)", model: "Dura-Ace",             sprockets: [50, 34] },
      { brand: "Shimano (Road)", model: "GRX-810",              sprockets: [48, 31] },
      { brand: "Shimano (Road)", model: "(DIY) Ultegra",        sprockets: [46, 34] },
      { brand: "Shimano (Road)", model: "(DIY) Ultegra",        sprockets: [50, 36] },
      { brand: "Shimano (MTB)",  model: "SLX M7000",            sprockets: [34, 24] },
      { brand: "Shimano (MTB)",  model: "SLX M7000",            sprockets: [36, 26] },
      { brand: "Shimano (MTB)",  model: "SLX M7000",            sprockets: [38, 28] },
      { brand: "Shimano (MTB)",  model: "Deore XT M8000",       sprockets: [34, 24] },
      { brand: "Shimano (MTB)",  model: "Deore XT M8000",       sprockets: [36, 26] },
      { brand: "Shimano (MTB)",  model: "Deore XT M8000",       sprockets: [38, 28] },
      { brand: "Shimano (MTB)",  model: "(DIY) Deore XT M8000", sprockets: [34, 22] },
      { brand: "Shimano (MTB)",  model: "(DIY) Deore XT M8000", sprockets: [34, 26] },
      { sprockets: [50, 34] },
    ]
  },
  {
...
var CLUSTERS_INFO = [
  ...
  },
  {
    ...
    infos: [
      ...
      { brand: "Shimano", model: "Tourney TX CS-HG200-8", sprockets: [12, 14, 16, 18, 21, 24, 28, 32], url: "https://bike.shimano.com/en-UK/products/components/pdp.P-CS-HG200-8.html" },
  ...
  },
  {
    ...
    infos: [
      ...
      { brand: "JFOYH Ultralight",                      sprockets: [11, 13, 15, 17, 19, 21, 23, 25, 28, 31, 34], grams: 239 },
      { brand: "JFOYH Ultralight",                      sprockets: [11, 13, 15, 17, 19, 21, 23, 25, 28, 32, 36], grams: 239 },
      { brand: "Meroca/Sunshine", model: "Ultra-Light", sprockets: [11, 13, 15, 17, 19, 21, 24, 28, 32, 36, 42], grams: 385 },
      { brand: "Meroca/Sunshine", model: "Ultra-Light", sprockets: [11, 13, 15, 18, 21, 24, 28, 32, 36, 40, 46], grams: 432 },
      { brand: "Meroca/Sunshine", model: "Ultra-Light", sprockets: [11, 13, 15, 18, 21, 24, 28, 32, 36, 42, 50], grams: 447 },
      ...
      { brand: "Shimano",   model: "Deore CS-M5100",    sprockets: [11, 13, 15, 18, 21, 24, 28, 33, 39, 45, 51], grams: 627 },
